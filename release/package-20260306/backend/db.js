...
const isDeployEnv =
  appEnv === 'production' || appEnv === 'prod' || process.env.DEPLOY_ENV === '1' || process.env.DEPLOY === '1'
...
const dbPassword = hasEnvPassword ? process.env.DB_PASSWORD : isDeployEnv ? '' : fileConfig.password || ''
