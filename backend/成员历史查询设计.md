    ...
    <el-card class="history-list-card">
      ...
      <el-table :data="historyList" style="width: 100%">
        <el-table-column prop="term_number" label="届数" width="100">
          <template slot-scope="scope"> 第{{ scope.row.term_number }}届 </template>
        </el-table-column>
        ...
        <el-table-column label="任职时长" width="120">
          <template slot-scope="scope"> {{ calculateTermDays(scope.row) }}天 </template>
        </el-table-column>
      </el-table>
    </el-card>
  ...
  computed: {
    sortedHistory() {
      return [...this.historyList].sort(
        (a, b) => new Date(b.term_start_date) - new Date(a.term_start_date)
      )
    }
  },
  methods: {
