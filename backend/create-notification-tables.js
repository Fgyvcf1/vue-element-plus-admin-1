...
function insertDefaultReminderRules() {
  ...
  const defaultRules = [
    { rule_type: 'age', rule_name: '60岁提醒', rule_value: '60', reminder_days: 1, description: '居民满60岁前1天提醒' },
    { rule_type: 'age', rule_name: '80岁提醒', rule_value: '80', reminder_days: 7, description: '居民满80岁前7天提醒' },
    { rule_type: 'age', rule_name: '90岁提醒', rule_value: '90', reminder_days: 14, description: '居民满90岁前14天提醒' },
    { rule_type: 'age', rule_name: '100岁提醒', rule_value: '100', reminder_days: 30, description: '居民满100岁前30天提醒' }
  ];
  ...
  defaultRules.forEach(rule => {
    db.run(insertRuleSql, [rule.rule_type, rule.rule_name, rule.rule_value, rule.reminder_days, rule.description, 'active'], function(err) {
      if (err) {
