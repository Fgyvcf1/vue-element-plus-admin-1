...
// 添加低收入人员及政策记录（事务）
router.post('/low-income-persons-with-policy', specialPeopleController.addLowIncomePersonWithPolicy);
...
// 获取该户所有成员享受总金额
router.get('/low-income-persons/:id/household-total-subsidy', specialPeopleController.getHouseholdTotalSubsidy);
