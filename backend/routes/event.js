...
// 列表
router.get('/', checkPermission('todo:view'), (req, res) => {
...
// 新增
router.post('/', checkPermission('todo:add'), (req, res) => {
...
// 更新
router.put('/:id', checkPermission('todo:edit'), (req, res) => {
...
// 删除
router.delete('/:id', checkPermission('todo:delete'), (req, res) => {
