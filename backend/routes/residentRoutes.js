    ...
    if (villageGroup && villageGroup.length > 0) {
      ...
      const getChineseFirstLetter = (char) => {
        ...
        const pinyinMap = {
          ...
          '阿': 'A', '艾': 'A', '安': 'A', '奥': 'A',
          // B
          '巴': 'B', '白': 'B', '百': 'B', '柏': 'B', '班': 'B', '半': 'B', '邦': 'B', '宝': 'B', '保': 'B', '堡': 'B',
          '北': 'B', '贝': 'B', '本': 'B', '比': 'B', '必': 'B', '边': 'B', '变': 'B', '标': 'B', '表': 'B', '别': 'B',
          '宾': 'B', '兵': 'B', '冰': 'B', '丙': 'B', '病': 'B', '波': 'B', '博': 'B', '伯': 'B', '泊': 'B', '卜': 'B',
          '不': 'B', '布': 'B', '步': 'B', '部': 'B',
          // C
          '才': 'C', '材': 'C', '财': 'C', '采': 'C', '彩': 'C', '菜': 'C', '蔡': 'C', '参': 'C', '残': 'C', '蚕': 'C',
          '仓': 'C', '苍': 'C', '藏': 'C', '操': 'C', '曹': 'C', '草': 'C', '册': 'C', '侧': 'C', '测': 'C', '策': 'C',
          '层': 'C', '曾': 'C', '茶': 'C', '查': 'C', '察': 'C', '差': 'C', '拆': 'C', '柴': 'C', '缠': 'C', '产': 'C',
          '昌': 'C', '长': 'C', '场': 'C', '厂': 'C', '抄': 'C', '超': 'C', '朝': 'C', '潮': 'C', '车': 'C', '扯': 'C',
          '陈': 'C', '晨': 'C', '沉': 'C', '称': 'C', '城': 'C', '成': 'C', '承': 'C', '诚': 'C', '吃': 'C', '池': 'C',
          '驰': 'C', '迟': 'C', '持': 'C', '尺': 'C', '齿': 'C', '赤': 'C', '充': 'C', '冲': 'C', '虫': 'C', '崇': 'C',
          '抽': 'C', '仇': 'C', '绸': 'C', '愁': 'C', '筹': 'C', '丑': 'C', '初': 'C', '出': 'C', '础': 'C', '储': 'C',
          '楚': 'C', '处': 'C', '川': 'C', '穿': 'C', '传': 'C', '船': 'C', '窗': 'C', '床': 'C', '创': 'C', '春': 'C',
          '纯': 'C', '唇': 'C', '词': 'C', '慈': 'C', '辞': 'C', '磁': 'C', '雌': 'C', '次': 'C', '刺': 'C', '从': 'C',
          '匆': 'C', '葱': 'C', '聪': 'C', '丛': 'C', '凑': 'C', '粗': 'C', '促': 'C', '村': 'C', '存': 'C', '寸': 'C',
          '错': 'C',
          // D
          '达': 'D', '答': 'D', '打': 'D', '大': 'D', '代': 'D', '带': 'D', '待': 'D', '袋': 'D', '戴': 'D', '丹': 'D',
          '单': 'D', '担': 'D', '胆': 'D', '旦': 'D', '但': 'D', '诞': 'D', '弹': 'D', '淡': 'D', '蛋': 'D', '当': 'D',
          '挡': 'D', '党': 'D', '荡': 'D', '刀': 'D', '导': 'D', '岛': 'D', '倒': 'D', '蹈': 'D', '到': 'D', '盗': 'D',
          '道': 'D', '德': 'D', '得': 'D', '灯': 'D', '登': 'D', '等': 'D', '邓': 'D', '堤': 'D', '低': 'D', '滴': 'D',
          '迪': 'D', '敌': 'D', '笛': 'D', '底': 'D', '地': 'D', '弟': 'D', '帝': 'D', '递': 'D', '第': 'D', '颠': 'D',
          '典': 'D', '点': 'D', '电': 'D', '店': 'D', '殿': 'D', '雕': 'D', '吊': 'D', '调': 'D', '跌': 'D', '爹': 'D',
          '叠': 'D', '丁': 'D', '叮': 'D', '钉': 'D', '顶': 'D', '订': 'D', '定': 'D', '东': 'D', '冬': 'D', '董': 'D',
          '懂': 'D', '动': 'D', '冻': 'D', '栋': 'D', '洞': 'D', '都': 'D', '斗': 'D', '豆': 'D', '督': 'D', '毒': 'D',
          '读': 'D', '独': 'D', '堵': 'D', '赌': 'D', '杜': 'D', '肚': 'D', '度': 'D', '渡': 'D', '端': 'D', '短': 'D',
          '段': 'D', '断': 'D', '堆': 'D', '队': 'D', '对': 'D', '吨': 'D', '敦': 'D', '蹲': 'D', '盾': 'D', '多': 'D',
          '夺': 'D', '朵': 'D', '躲': 'D',
          // E
          '俄': 'E', '额': 'E', '恶': 'E', '恩': 'E', '儿': 'E', '而': 'E', '耳': 'E', '二': 'E',
          // F
          '发': 'F', '乏': 'F', '伐': 'F', '罚': 'F', '法': 'F', '帆': 'F', '番': 'F', '翻': 'F', '凡': 'F', '烦': 'F',
          '繁': 'F', '反': 'F', '返': 'F', '犯': 'F', '泛': 'F', '饭': 'F', '范': 'F', '贩': 'F', '方': 'F', '芳': 'F',
          '房': 'F', '防': 'F', '妨': 'F', '仿': 'F', '访': 'F', '纺': 'F', '放': 'F', '飞': 'F', '非': 'F', '菲': 'F',
          '肥': 'F', '匪': 'F', '废': 'F', '沸': 'F', '费': 'F', '芬': 'F', '纷': 'F', '坟': 'F', '粉': 'F', '份': 'F',
          '奋': 'F', '愤': 'F', '丰': 'F', '风': 'F', '枫': 'F', '封': 'F', '疯': 'F', '峰': 'F', '锋': 'F', '蜂': 'F',
          '冯': 'F', '逢': 'F', '缝': 'F', '凤': 'F', '奉': 'F', '佛': 'F', '夫': 'F', '肤': 'F', '孵': 'F', '扶': 'F',
          '拂': 'F', '服': 'F', '浮': 'F', '符': 'F', '幅': 'F', '福': 'F', '抚': 'F', '府': 'F', '斧': 'F', '俯': 'F',
          '辅': 'F', '腐': 'F', '父': 'F', '付': 'F', '妇': 'F', '负': 'F', '附': 'F', '复': 'F', '赴': 'F', '副': 'F',
          '傅': 'F', '富': 'F', '赋': 'F', '腹': 'F', '覆': 'F',
          // G
          '该': 'G', '改': 'G', '盖': 'G', '干': 'G', '甘': 'G', '杆': 'G', '肝': 'G', '赶': 'G', '敢': 'G', '感': 'G',
          '刚': 'G', '岗': 'G', '纲': 'G', '缸': 'G', '钢': 'G', '港': 'G', '高': 'G', '搞': 'G', '稿': 'G', '告': 'G',
          '戈': 'G', '哥': 'G', '歌': 'G', '阁': 'G', '革': 'G', '格': 'G', '葛': 'G', '隔': 'G', '个': 'G', '各': 'G',
          '给': 'G', '根': 'G', '跟': 'G', '更': 'G', '耕': 'G', '工': 'G', '弓': 'G', '公': 'G', '功': 'G', '攻': 'G',
          '供': 'G', '宫': 'G', '恭': 'G', '龚': 'G', '共': 'G', '贡': 'G', '勾': 'G', '沟': 'G', '钩': 'G', '狗': 'G',
          '构': 'G', '购': 'G', '够': 'G', '姑': 'G', '孤': 'G', '古': 'G', '谷': 'G', '股': 'G', '骨': 'G', '鼓': 'G',
          '固': 'G', '故': 'G', '顾': 'G', '瓜': 'G', '刮': 'G', '挂': 'G', '乖': 'G', '拐': 'G', '怪': 'G', '关': 'G',
          '观': 'G', '官': 'G', '馆': 'G', '管': 'G', '贯': 'G', '惯': 'G', '灌': 'G', '光': 'G', '广': 'G', '归': 'G',
          '龟': 'G', '规': 'G', '轨': 'G', '鬼': 'G', '桂': 'G', '柜': 'G', '贵': 'G', '桂': 'G', '滚': 'G', '郭': 'G',
          '国': 'G', '果': 'G', '过': 'G',
          // H
          '哈': 'H', '孩': 'H', '海': 'H', '害': 'H', '寒': 'H', '韩': 'H', '汉': 'H', '汗': 'H', '杭': 'H', '航': 'H',
          '毫': 'H', '好': 'H', '号': 'H', '浩': 'H', '耗': 'H', '何': 'H', '河': 'H', '和': 'H', '核': 'H', '荷': 'H',
          '贺': 'H', '赫': 'H', '褐': 'H', '鹤': 'H', '黑': 'H', '痕': 'H', '很': 'H', '狠': 'H', '恨': 'H', '恒': 'H',
          '横': 'H', '衡': 'H', '轰': 'H', '哄': 'H', '红': 'H', '宏': 'H', '洪': 'H', '虹': 'H', '侯': 'H', '喉': 'H',
          '猴': 'H', '吼': 'H', '后': 'H', '厚': 'H', '候': 'H', '乎': 'H', '呼': 'H', '忽': 'H', '狐': 'H', '胡': 'H',
          '壶': 'H', '湖': 'H', '葫': 'H', '糊': 'H', '蝴': 'H', '虎': 'H', '互': 'H', '户': 'H', '护': 'H', '花': 'H',
          '华': 'H', '划': 'H', '化': 'H', '划': 'H', '怀': 'H', '淮': 'H', '坏': 'H', '欢': 'H', '还': 'H', '环': 'H',
          '缓': 'H', '幻': 'H', '换': 'H', '唤': 'H', '患': 'H', '荒': 'H', '皇': 'H', '黄': 'H', '煌': 'H', '晃': 'H',
          '灰': 'H', '恢': 'H', '挥': 'H', '辉': 'H', '回': 'H', '毁': 'H', '悔': 'H', '汇': 'H', '会': 'H', '绘': 'H',
          '婚': 'H', '浑': 'H', '魂': 'H', '混': 'H', '活': 'H', '火': 'H', '伙': 'H', '或': 'H', '货': 'H', '获': 'H',
          '祸': 'H', '惑': 'H', '霍': 'H',
          // J
          '机': 'J', '鸡': 'J', '积': 'J', '基': 'J', '激': 'J', '及': 'J', '吉': 'J', '级': 'J', '即': 'J', '极': 'J',
          '急': 'J', '疾': 'J', '集': 'J', '籍': 'J', '辑': 'J', '籍': 'J', '几': 'J', '己': 'J', '挤': 'J', '济': 'J',
          '计': 'J', '记': 'J', '纪': 'J', '技': 'J', '际': 'J', '季': 'J', '剂': 'J', '济': 'J', '既': 'J', '继': 'J',
          '寄': 'J', '加': 'J', '夹': 'J', '佳': 'J', '家': 'J', '嘉': 'J', '甲': 'J', '价': 'J', '驾': 'J', '架': 'J',
          '假': 'J', '嫁': 'J', '歼': 'J', '坚': 'J', '间': 'J', '艰': 'J', '肩': 'J', '监': 'J', '兼': 'J', '煎': 'J',
          '拣': 'J', '俭': 'J', '茧': 'J', '捡': 'J', '减': 'J', '剪': 'J', '检': 'J', '简': 'J', '见': 'J', '件': 'J',
          '建': 'J', '剑': 'J', '荐': 'J', '贱': 'J', '健': 'J', '舰': 'J', '渐': 'J', '践': 'J', '鉴': 'J', '键': 'J',
          '江': 'J', '将': 'J', '姜': 'J', '浆': 'J', '僵': 'J', '疆': 'J', '讲': 'J', '奖': 'J', '匠': 'J', '降': 'J',
          '交': 'J', '郊': 'J', '娇': 'J', '浇': 'J', '骄': 'J', '胶': 'J', '教': 'J', '焦': 'J', '蕉': 'J', '礁': 'J',
          '嚼': 'J', '角': 'J', '饺': 'J', '脚': 'J', '搅': 'J', '缴': 'J', '叫': 'J', '较': 'J', '教': 'J', '阶': 'J',
          '皆': 'J', '接': 'J', '揭': 'J', '街': 'J', '节': 'J', '劫': 'J', '杰': 'J', '洁': 'J', '结': 'J', '捷': 'J',
          '截': 'J', '竭': 'J', '姐': 'J', '解': 'J', '介': 'J', '戒': 'J', '届': 'J', '界': 'J', '借': 'J', '巾': 'J',
          '今': 'J', '金': 'J', '津': 'J', '筋': 'J', '斤': 'J', '仅': 'J', '紧': 'J', '锦': 'J', '尽': 'J', '劲': 'J',
          '近': 'J', '进': 'J', '晋': 'J', '浸': 'J', '尽': 'J', '京': 'J', '经': 'J', '茎': 'J', '惊': 'J', '晶': 'J',
          '睛': 'J', '精': 'J', '井': 'J', '颈': 'J', '景': 'J', '警': 'J', '净': 'J', '静': 'J', '境': 'J', '敬': 'J',
          '镜': 'J', '纠': 'J', '究': 'J', '揪': 'J', '九': 'J', '久': 'J', '酒': 'J', '旧': 'J', '救': 'J', '就': 'J',
          '舅': 'J', '居': 'J', '拘': 'J', '驹': 'J', '鞠': 'J', '局': 'J', '菊': 'J', '橘': 'J', '举': 'J', '矩': 'J',
          '句': 'J', '巨': 'J', '拒': 'J', '具': 'J', '俱': 'J', '剧': 'J', '惧': 'J', '据': 'J', '距': 'J', '锯': 'J',
          '聚': 'J', '捐': 'J', '卷': 'J', '决': 'J', '绝': 'J', '觉': 'J', '掘': 'J', '嚼': 'J', '军': 'J', '君': 'J',
          '均': 'J', '菌': 'J', '俊': 'J',
          // K
          '卡': 'K', '开': 'K', '凯': 'K', '慨': 'K', '刊': 'K', '堪': 'K', '砍': 'K', '看': 'K', '康': 'K', '慷': 'K',
          '扛': 'K', '亢': 'K', '抗': 'K', '炕': 'K', '考': 'K', '烤': 'K', '靠': 'K', '科': 'K', '棵': 'K', '颗': 'K',
          '科': 'K', '壳': 'K', '咳': 'K', '可': 'K', '渴': 'K', '克': 'K', '刻': 'K', '客': 'K', '课': 'K', '肯': 'K',
          '垦': 'K', '恳': 'K', '坑': 'K', '空': 'K', '孔': 'K', '恐': 'K', '控': 'K', '口': 'K', '扣': 'K', '寇': 'K',
          '枯': 'K', '哭': 'K', '苦': 'K', '库': 'K', '裤': 'K', '酷': 'K', '夸': 'K', '垮': 'K', '挎': 'K', '跨': 'K',
          '块': 'K', '快': 'K', '宽': 'K', '款': 'K', '狂': 'K', '况': 'K', '矿': 'K', '框': 'K', '亏': 'K', '葵': 'K',
          '愧': 'K', '溃': 'K', '坤': 'K', '昆': 'K', '捆': 'K', '困': 'K', '扩': 'K', '括': 'K',
          // L
          '垃': 'L', '拉': 'L', '啦': 'L', '腊': 'L', '辣': 'L', '来': 'L', '赖': 'L', '兰': 'L', '栏': 'L', '蓝': 'L',
          '览': 'L', '懒': 'L', '烂': 'L', '滥': 'L', '郎': 'L', '狼': 'L', '廊': 'L', '朗': 'L', '浪': 'L', '捞': 'L',
          '劳': 'L', '牢': 'L', '老': 'L', '姥': 'L', '涝': 'L', '乐': 'L', '勒': 'L', '雷': 'L', '垒': 'L', '累': 'L',
          '泪': 'L', '类': 'L', '冷': 'L', '愣': 'L', '黎': 'L', '礼': 'L', '李': 'L', '里': 'L', '理': 'L', '鲤': 'L',
          '力': 'L', '历': 'L', '厉': 'L', '立': 'L', '丽': 'L', '利': 'L', '励': 'L', '例': 'L', '隶': 'L', '栗': 'L',
          '粒': 'L', '俩': 'L', '连': 'L', '帘': 'L', '怜': 'L', '莲': 'L', '联': 'L', '廉': 'L', '镰': 'L', '脸': 'L',
          '练': 'L', '炼': 'L', '恋': 'L', '良': 'L', '凉': 'L', '梁': 'L', '粮': 'L', '两': 'L', '亮': 'L', '谅': 'L',
          '辆': 'L', '量': 'L', '辽': 'L', '疗': 'L', '聊': 'L', '僚': 'L', '寥': 'L', '了': 'L', '料': 'L', '列': 'L',
          '劣': 'L', '烈': 'L', '猎': 'L', '裂': 'L', '林': 'L', '临': 'L', '淋': 'L', '磷': 'L', '灵': 'L', '玲': 'L',
          '凌': 'L', '铃': 'L', '陵': 'L', '领': 'L', '岭': 'L', '令': 'L', '溜': 'L', '刘': 'L', '流': 'L', '留': 'L',
          '硫': 'L', '榴': 'L', '柳': 'L', '六': 'L', '龙': 'L', '聋': 'L', '笼': 'L', '隆': 'L', '垄': 'L', '拢': 'L',
          '楼': 'L', '漏': 'L', '露': 'L', '卢': 'L', '芦': 'L', '炉': 'L', '鲁': 'L', '陆': 'L', '录': 'L', '鹿': 'L',
          '滤': 'L', '碌': 'L', '路': 'L', '露': 'L', '驴': 'L', '旅': 'L', '铝': 'L', '律': 'L', '虑': 'L', '率': 'L',
          '绿': 'L', '氯': 'L', '卵': 'L', '乱': 'L', '掠': 'L', '略': 'L', '伦': 'L', '轮': 'L', '论': 'L', '罗': 'L',
          '萝': 'L', '逻': 'L', '锣': 'L', '箩': 'L', '骡': 'L', '螺': 'L', '裸': 'L', '洛': 'L', '络': 'L', '骆': 'L',
          '落': 'L',
          // M
          '妈': 'M', '麻': 'M', '马': 'M', '码': 'M', '蚂': 'M', '骂': 'M', '吗': 'M', '埋': 'M', '买': 'M', '迈': 'M',
          '麦': 'M', '卖': 'M', '脉': 'M', '蛮': 'M', '满': 'M', '曼': 'M', '慢': 'M', '漫': 'M', '忙': 'M', '芒': 'M',
          '盲': 'M', '茫': 'M', '莽': 'M', '猫': 'M', '毛': 'M', '矛': 'M', '茅': 'M', '茂': 'M', '冒': 'M', '贸': 'M',
          '帽': 'M', '貌': 'M', '么': 'M', '没': 'M', '枚': 'M', '玫': 'M', '眉': 'M', '梅': 'M', '媒': 'M', '煤': 'M',
          '霉': 'M', '每': 'M', '美': 'M', '妹': 'M', '昧': 'M', '门': 'M', '闷': 'M', '们': 'M', '蒙': 'M', '盟': 'M',
          '猛': 'M', '梦': 'M', '孟': 'M', '迷': 'M', '谜': 'M', '米': 'M', '泌': 'M', '秘': 'M', '密': 'M', '蜜': 'M',
          '眠': 'M', '绵': 'M', '棉': 'M', '免': 'M', '勉': 'M', '缅': 'M', '面': 'M', '苗': 'M', '描': 'M', '瞄': 'M',
          '秒': 'M', '妙': 'M', '庙': 'M', '灭': 'M', '蔑': 'M', '民': 'M', '敏': 'M', '名': 'M', '明': 'M', '鸣': 'M',
          '命': 'M', '摸': 'M', '模': 'M', '膜': 'M', '摩': 'M', '磨': 'M', '蘑': 'M', '魔': 'M', '抹': 'M', '末': 'M',
          '沫': 'M', '陌': 'M', '莫': 'M', '漠': 'M', '寞': 'M', '墨': 'M', '默': 'M', '谋': 'M', '某': 'M', '母': 'M',
          '亩': 'M', '牡': 'M', '姆': 'M', '拇': 'M', '木': 'M', '目': 'M', '牧': 'M', '墓': 'M', '幕': 'M', '慕': 'M',
          '暮': 'M', '穆': 'M',
          // N
          '拿': 'N', '哪': 'N', '内': 'N', '那': 'N', '纳': 'N', '钠': 'N', '乃': 'N', '奶': 'N', '奈': 'N', '耐': 'N',
          '男': 'N', '南': 'N', '难': 'N', '囊': 'N', '挠': 'N', '恼': 'N', '脑': 'N', '闹': 'N', '呢': 'N', '馁': 'N',
          '嫩': 'N', '能': 'N', '尼': 'N', '泥': 'N', '你': 'N', '拟': 'N', '逆': 'N', '年': 'N', '念': 'N', '娘': 'N',
          '酿': 'N', '鸟': 'N', '尿': 'N', '捏': 'N', '聂': 'N', '宁': 'N', '凝': 'N', '牛': 'N', '扭': 'N', '纽': 'N',
          '浓': 'N', '农': 'N', '弄': 'N', '奴': 'N', '努': 'N', '怒': 'N', '女': 'N', '暖': 'N', '虐': 'N', '挪': 'N',
          '懦': 'N', '糯': 'N',
          // O
          '欧': 'O', '殴': 'O', '鸥': 'O', '偶': 'O',
          // P
          '趴': 'P', '啪': 'P', '爬': 'P', '怕': 'P', '拍': 'P', '排': 'P', '牌': 'P', '派': 'P', '攀': 'P', '盘': 'P',
          '判': 'P', '叛': 'P', '盼': 'P', '乓': 'P', '旁': 'P', '庞': 'P', '胖': 'P', '抛': 'P', '刨': 'P', '炮': 'P',
          '袍': 'P', '跑': 'P', '泡': 'P', '呸': 'P', '胚': 'P', '陪': 'P', '培': 'P', '赔': 'P', '佩': 'P', '配': 'P',
          '喷': 'P', '盆': 'P', '朋': 'P', '棚': 'P', '蓬': 'P', '鹏': 'P', '捧': 'P', '碰': 'P', '批': 'P', '披': 'P',
          '劈': 'P', '皮': 'P', '疲': 'P', '脾': 'P', '匹': 'P', '痞': 'P', '僻': 'P', '片': 'P', '偏': 'P', '篇': 'P',
          '骗': 'P', '漂': 'P', '飘': 'P', '票': 'P', '撇': 'P', '拼': 'P', '贫': 'P', '品': 'P', '聘': 'P', '乒': 'P',
          '平': 'P', '评': 'P', '凭': 'P', '苹': 'P', '屏': 'P', '瓶': 'P', '坡': 'P', '泼': 'P', '颇': 'P', '婆': 'P',
          '迫': 'P', '破': 'P', '魄': 'P', '剖': 'P', '仆': 'P', '扑': 'P', '铺': 'P', '葡': 'P', '蒲': 'P', '朴': 'P',
          '圃': 'P', '浦': 'P', '普': 'P', '谱': 'P',
          // Q
          '七': 'Q', '妻': 'Q', '戚': 'Q', '欺': 'Q', '漆': 'Q', '齐': 'Q', '其': 'Q', '奇': 'Q', '歧': 'Q', '骑': 'Q',
          '棋': 'Q', '旗': 'Q', '乞': 'Q', '企': 'Q', '岂': 'Q', '启': 'Q', '起': 'Q', '气': 'Q', '讫': 'Q', '迄': 'Q',
          '弃': 'Q', '汽': 'Q', '砌': 'Q', '器': 'Q', '恰': 'Q', '洽': 'Q', '千': 'Q', '迁': 'Q', '牵': 'Q', '铅': 'Q',
          '谦': 'Q', '签': 'Q', '前': 'Q', '钱': 'Q', '钳': 'Q', '乾': 'Q', '潜': 'Q', '浅': 'Q', '遣': 'Q', '谴': 'Q',
          '欠': 'Q', '枪': 'Q', '腔': 'Q', '强': 'Q', '墙': 'Q', '抢': 'Q', '悄': 'Q', '敲': 'Q', '锹': 'Q', '乔': 'Q',
          '侨': 'Q', '桥': 'Q', '瞧': 'Q', '巧': 'Q', '俏': 'Q', '切': 'Q', '且': 'Q', '窃': 'Q', '亲': 'Q', '侵': 'Q',
          '钦': 'Q', '琴': 'Q', '禽': 'Q', '勤': 'Q', '擒': 'Q', '寝': 'Q', '沁': 'Q', '青': 'Q', '轻': 'Q', '氢': 'Q',
          '倾': 'Q', '卿': 'Q', '清': 'Q', '蜻': 'Q', '情': 'Q', '晴': 'Q', '擎': 'Q', '顷': 'Q', '请': 'Q', '庆': 'Q',
          '穷': 'Q', '琼': 'Q', '丘': 'Q', '秋': 'Q', '蚯': 'Q', '求': 'Q', '球': 'Q', '区': 'Q', '曲': 'Q', '驱': 'Q',
          '屈': 'Q', '躯': 'Q', '趋': 'Q', '渠': 'Q', '取': 'Q', '娶': 'Q', '去': 'Q', '趣': 'Q', '圈': 'Q', '权': 'Q',
          '全': 'Q', '泉': 'Q', '拳': 'Q', '犬': 'Q', '劝': 'Q', '券': 'Q', '缺': 'Q', '却': 'Q', '鹊': 'Q', '确': 'Q',
          '裙': 'Q', '群': 'Q',
          // R
          '然': 'R', '燃': 'R', '染': 'R', '嚷': 'R', '壤': 'R', '让': 'R', '饶': 'R', '扰': 'R', '绕': 'R', '惹': 'R',
          '热': 'R', '人': 'R', '仁': 'R', '忍': 'R', '认': 'R', '任': 'R', '刃': 'R', '纫': 'R', '扔': 'R', '仍': 'R',
          '日': 'R', '荣': 'R', '绒': 'R', '容': 'R', '熔': 'R', '溶': 'R', '蓉': 'R', '融': 'R', '冗': 'R', '柔': 'R',
          '肉': 'R', '如': 'R', '儒': 'R', '孺': 'R', '辱': 'R', '乳': 'R', '入': 'R', '软': 'R', '锐': 'R', '瑞': 'R',
          '润': 'R', '若': 'R', '弱': 'R',
          // S
          '撒': 'S', '洒': 'S', '塞': 'S', '腮': 'S', '赛': 'S', '三': 'S', '伞': 'S', '散': 'S', '桑': 'S', '嗓': 'S',
          '丧': 'S', '搔': 'S', '骚': 'S', '扫': 'S', '嫂': 'S', '色': 'S', '涩': 'S', '森': 'S', '僧': 'S', '杀': 'S',
          '沙': 'S', '纱': 'S', '刹': 'S', '砂': 'S', '傻': 'S', '煞': 'S', '厦': 'S', '筛': 'S', '晒': 'S', '山': 'S',
          '杉': 'S', '衫': 'S', '删': 'S', '闪': 'S', '陕': 'S', '扇': 'S', '善': 'S', '擅': 'S', '膳': 'S', '赡': 'S',
          '伤': 'S', '商': 'S', '裳': 'S', '晌': 'S', '赏': 'S', '上': 'S', '尚': 'S', '捎': 'S', '梢': 'S', '烧': 'S',
          '稍': 'S', '勺': 'S', '少': 'S', '绍': 'S', '哨': 'S', '奢': 'S', '舌': 'S', '蛇': 'S', '舍': 'S', '设': 'S',
          '社': 'S', '射': 'S', '涉': 'S', '摄': 'S', '申': 'S', '伸': 'S', '身': 'S', '深': 'S', '神': 'S', '审': 'S',
          '婶': 'S', '肾': 'S', '甚': 'S', '渗': 'S', '慎': 'S', '升': 'S', '生': 'S', '声': 'S', '牲': 'S', '胜': 'S',
          '绳': 'S', '省': 'S', '圣': 'S', '剩': 'S', '尸': 'S', '失': 'S', '师': 'S', '诗': 'S', '狮': 'S', '施': 'S',
          '湿': 'S', '十': 'S', '什': 'S', '石': 'S', '时': 'S', '识': 'S', '实': 'S', '拾': 'S', '食': 'S', '蚀': 'S',
          '史': 'S', '使': 'S', '始': 'S', '驶': 'S', '士': 'S', '氏': 'S', '世': 'S', '市': 'S', '示': 'S', '式': 'S',
          '事': 'S', '侍': 'S', '势': 'S', '视': 'S', '试': 'S', '饰': 'S', '室': 'S', '是': 'S', '适': 'S', '逝': 'S',
          '释': 'S', '誓': 'S', '收': 'S', '手': 'S', '守': 'S', '首': 'S', '寿': 'S', '受': 'S', '兽': 'S', '售': 'S',
          '授': 'S', '瘦': 'S', '书': 'S', '抒': 'S', '枢': 'S', '叔': 'S', '殊': 'S', '梳': 'S', '淑': 'S', '疏': 'S',
          '舒': 'S', '输': 'S', '蔬': 'S', '熟': 'S', '暑': 'S', '黍': 'S', '署': 'S', '蜀': 'S', '鼠': 'S', '属': 'S',
          '术': 'S', '束': 'S', '述': 'S', '树': 'S', '竖': 'S', '恕': 'S', '庶': 'S', '数': 'S', '刷': 'S', '耍': 'S',
          '衰': 'S', '摔': 'S', '甩': 'S', '帅': 'S', '拴': 'S', '霜': 'S', '双': 'S', '爽': 'S', '谁': 'S', '水': 'S',
          '税': 'S', '睡': 'S', '顺': 'S', '瞬': 'S', '说': 'S', '烁': 'S', '朔': 'S', '硕': 'S', '丝': 'S', '司': 'S',
          '私': 'S', '思': 'S', '斯': 'S', '死': 'S', '四': 'S', '寺': 'S', '似': 'S', '饲': 'S', '松': 'S', '怂': 'S',
          '耸': 'S', '送': 'S', '颂': 'S', '诵': 'S', '搜': 'S', '艘': 'S', '苏': 'S', '俗': 'S', '诉': 'S', '肃': 'S',
          '素': 'S', '速': 'S', '宿': 'S', '塑': 'S', '溯': 'S',
          // T
          '他': 'T', '它': 'T', '她': 'T', '塌': 'T', '踏': 'T', '塔': 'T', '獭': 'T', '蹋': 'T', '胎': 'T', '台': 'T',
          '抬': 'T', '苔': 'T', '太': 'T', '汰': 'T', '态': 'T', '泰': 'T', '贪': 'T', '摊': 'T', '滩': 'T', '瘫': 'T',
          '坛': 'T', '谈': 'T', '痰': 'T', '潭': 'T', '檀': 'T', '坦': 'T', '叹': 'T', '炭': 'T', '探': 'T', '碳': 'T',
          '汤': 'T', '唐': 'T', '堂': 'T', '塘': 'T', '糖': 'T', '倘': 'T', '淌': 'T', '躺': 'T', '烫': 'T', '涛': 'T',
          '掏': 'T', '滔': 'T', '逃': 'T', '桃': 'T', '陶': 'T', '萄': 'T', '淘': 'T', '讨': 'T', '套': 'T', '特': 'T',
          '疼': 'T', '腾': 'T', '藤': 'T', '梯': 'T', '踢': 'T', '啼': 'T', '提': 'T', '题': 'T', '蹄': 'T', '体': 'T',
          '替': 'T', '天': 'T', '添': 'T', '田': 'T', '填': 'T', '甜': 'T', '舔': 'T', '挑': 'T', '条': 'T', '迢': 'T',
          '跳': 'T', '贴': 'T', '铁': 'T', '帖': 'T', '厅': 'T', '听': 'T', '廷': 'T', '亭': 'T', '庭': 'T', '停': 'T',
          '挺': 'T', '艇': 'T', '通': 'T', '同': 'T', '彤': 'T', '桐': 'T', '铜': 'T', '童': 'T', '统': 'T', '桶': 'T',
          '筒': 'T', '痛': 'T', '偷': 'T', '头': 'T', '投': 'T', '透': 'T', '凸': 'T', '秃': 'T', '突': 'T', '图': 'T',
          '徒': 'T', '涂': 'T', '途': 'T', '屠': 'T', '土': 'T', '吐': 'T', '兔': 'T', '团': 'T', '推': 'T', '颓': 'T',
          '腿': 'T', '退': 'T', '吞': 'T', '屯': 'T', '托': 'T', '拖': 'T', '脱': 'T', '驮': 'T', '陀': 'T', '驼': 'T',
          '妥': 'T', '拓': 'T', '唾': 'T',
          // W
          '挖': 'W', '哇': 'W', '蛙': 'W', '娃': 'W', '瓦': 'W', '袜': 'W', '歪': 'W', '外': 'W', '弯': 'W', '湾': 'W',
          '丸': 'W', '完': 'W', '玩': 'W', '顽': 'W', '挽': 'W', '晚': 'W', '碗': 'W', '万': 'W', '汪': 'W', '亡': 'W',
          '王': 'W', '网': 'W', '往': 'W', '枉': 'W', '妄': 'W', '忘': 'W', '旺': 'W', '望': 'W', '危': 'W', '威': 'W',
          '微': 'W', '为': 'W', '围': 'W', '违': 'W', '唯': 'W', '惟': 'W', '维': 'W', '伟': 'W', '伪': 'W', '尾': 'W',
          '纬': 'W', '委': 'W', '卫': 'W', '未': 'W', '位': 'W', '味': 'W', '畏': 'W', '胃': 'W', '谓': 'W', '喂': 'W',
          '尉': 'W', '蔚': 'W', '慰': 'W', '魏': 'W', '温': 'W', '文': 'W', '纹': 'W', '蚊': 'W', '闻': 'W', '吻': 'W',
          '稳': 'W', '问': 'W', '翁': 'W', '窝': 'W', '我': 'W', '沃': 'W', '卧': 'W', '握': 'W', '乌': 'W', '污': 'W',
          '呜': 'W', '巫': 'W', '诬': 'W', '屋': 'W', '无': 'W', '吴': 'W', '吾': 'W', '梧': 'W', '蜈': 'W', '五': 'W',
          '午': 'W', '伍': 'W', '武': 'W', '侮': 'W', '捂': 'W', '鹉': 'W', '舞': 'W', '勿': 'W', '戊': 'W', '务': 'W',
          '物': 'W', '误': 'W', '悟': 'W', '晤': 'W', '雾': 'W', '夕': 'W', '西': 'X', '吸': 'X', '希': 'X', '昔': 'X',
          // X
          '析': 'X', '牺': 'X', '息': 'X', '惜': 'X', '悉': 'X', '蟋': 'X', '锡': 'X', '熙': 'X', '嘻': 'X', '嬉': 'X',
          '膝': 'X', '习': 'X', '席': 'X', '袭': 'X', '媳': 'X', '洗': 'X', '喜': 'X', '戏': 'X', '系': 'X', '细': 'X',
          '隙': 'X', '虾': 'X', '瞎': 'X', '峡': 'X', '狭': 'X', '匣': 'X', '霞': 'X', '辖': 'X', '暇': 'X', '下': 'X',
          '夏': 'X', '吓': 'X', '掀': 'X', '先': 'X', '仙': 'X', '纤': 'X', '鲜': 'X', '闲': 'X', '贤': 'X', '咸': 'X',
          '涎': 'X', '衔': 'X', '嫌': 'X', '显': 'X', '险': 'X', '县': 'X', '现': 'X', '限': 'X', '线': 'X', '宪': 'X',
          '陷': 'X', '馅': 'X', '羡': 'X', '献': 'X', '腺': 'X', '乡': 'X', '相': 'X', '香': 'X', '厢': 'X', '湘': 'X',
          '箱': 'B', '详': 'X', '祥': 'X', '翔': 'X', '享': 'X', '响': 'X', '想': 'X', '向': 'X', '巷': 'X', '项': 'X',
          '象': 'X', '像': 'X', '橡': 'X', '削': 'X', '消': 'X', '宵': 'X', '硝': 'X', '霄': 'X', '嚣': 'X', '小': 'X',
          '晓': 'X', '孝': 'X', '效': 'X', '校': 'X', '笑': 'X', '些': 'X', '歇': 'X', '协': 'X', '邪': 'X', '胁': 'X',
          '斜': 'X', '谐': 'X', '携': 'X', '鞋': 'X', '写': 'X', '泄': 'X', '泻': 'X', '卸': 'X', '屑': 'X', '械': 'X',
          '谢': 'X', '懈': 'X', '蟹': 'X', '心': 'X', '辛': 'X', '欣': 'X', '新': 'X', '薪': 'X', '信': 'X', '兴': 'X',
          '星': 'X', '腥': 'X', '刑': 'X', '行': 'X', '形': 'X', '型': 'X', '醒': 'X', '杏': 'X', '姓': 'X', '幸': 'X',
          '性': 'X', '凶': 'X', '兄': 'X', '匈': 'X', '汹': 'X', '胸': 'X', '雄': 'X', '熊': 'X', '休': 'X', '修': 'X',
          '羞': 'X', '朽': 'X', '秀': 'X', '袖': 'X', '锈': 'X', '嗅': 'X', '虚': 'X', '需': 'X', '徐': 'X', '许': 'X',
          '序': 'X', '叙': 'X', '畜': 'X', '绪': 'X', '续': 'X', '絮': 'X', '婿': 'X', '蓄': 'X', '宣': 'X', '悬': 'X',
          '旋': 'X', '选': 'X', '癣': 'X', '炫': 'X', '眩': 'X', '绚': 'X', '靴': 'X', '学': 'X', '穴': 'X', '雪': 'X',
          '血': 'X', '勋': 'X', '熏': 'X', '寻': 'X', '巡': 'X', '旬': 'X', '驯': 'X', '询': 'X', '循': 'X', '训': 'X',
          '讯': 'X', '汛': 'X', '迅': 'X', '压': 'Y', '呀': 'Y', '鸦': 'Y', '鸭': 'Y', '牙': 'Y', '芽': 'Y', '蚜': 'Y',
          // Y
          '崖': 'Y', '涯': 'Y', '衙': 'Y', '雅': 'Y', '亚': 'Y', '咽': 'Y', '烟': 'Y', '淹': 'Y', '盐': 'Y', '严': 'Y',
          '言': 'Y', '岩': 'Y', '炎': 'Y', '沿': 'Y', '研': 'Y', '盐': 'Y', '蜒': 'Y', '颜': 'Y', '掩': 'Y', '眼': 'Y',
          '演': 'Y', '厌': 'Y', '宴': 'Y', '艳': 'Y', '验': 'Y', '谚': 'Y', '焰': 'Y', '雁': 'Y', '燕': 'Y', '央': 'Y',
          '扬': 'Y', '羊': 'Y', '阳': 'Y', '杨': 'Y', '佯': 'Y', '洋': 'Y', '仰': 'Y', '养': 'Y', '氧': 'Y', '痒': 'Y',
          '样': 'Y', '夭': 'Y', '妖': 'Y', '腰': 'Y', '邀': 'Y', '窑': 'Y', '谣': 'Y', '摇': 'Y', '遥': 'Y', '肴': 'Y',
          '姚': 'Y', '咬': 'Y', '舀': 'Y', '药': 'Y', '要': 'Y', '耀': 'Y', '爷': 'Y', '耶': 'Y', '野': 'Y', '也': 'Y',
          '冶': 'Y', '页': 'Y', '夜': 'Y', '液': 'Y', '一': 'Y', '衣': 'Y', '医': 'Y', '依': 'Y', '伊': 'Y', '揖': 'Y',
          '仪': 'Y', '夷': 'Y', '宜': 'Y', '移': 'Y', '遗': 'Y', '疑': 'Y', '乙': 'Y', '已': 'Y', '以': 'Y', '矣': 'Y',
          '蚁': 'Y', '椅': 'Y', '义': 'Y', '亿': 'Y', '忆': 'Y', '艺': 'Y', '议': 'Y', '亦': 'Y', '异': 'Y', '役': 'Y',
          '抑': 'Y', '译': 'Y', '易': 'Y', '疫': 'Y', '益': 'Y', '谊': 'Y', '逸': 'Y', '意': 'Y', '溢': 'Y', '毅': 'Y',
          '翼': 'Y', '因': 'Y', '阴': 'Y', '音': 'Y', '姻': 'Y', '吟': 'Y', '银': 'Y', '引': 'Y', '饮': 'Y', '隐': 'Y',
          '印': 'Y', '应': 'Y', '英': 'Y', '婴': 'Y', '樱': 'Y', '鹰': 'Y', '迎': 'Y', '盈': 'Y', '营': 'Y', '蝇': 'Y',
          '赢': 'Y', '影': 'Y', '映': 'Y', '硬': 'Y', '哟': 'Y', '拥': 'Y', '佣': 'Y', '痈': 'Y', '庸': 'Y', '雍': 'Y',
          '永': 'Y', '泳': 'Y', '勇': 'Y', '涌': 'Y', '用': 'Y', '优': 'Y', '忧': 'Y', '悠': 'Y', '尤': 'Y', '由': 'Y',
          '犹': 'Y', '邮': 'Y', '油': 'Y', '游': 'Y', '友': 'Y', '有': 'Y', '又': 'Y', '右': 'Y', '幼': 'Y', '诱': 'Y',
          '于': 'Y', '予': 'Y', '余': 'Y', '鱼': 'Y', '娱': 'Y', '渔': 'Y', '愉': 'Y', '愚': 'Y', '榆': 'Y', '与': 'Y',
          '宇': 'Y', '羽': 'Y', '雨': 'Y', '语': 'Y', '玉': 'Y', '驭': 'Y', '芋': 'Y', '育': 'Y', '郁': 'Y', '狱': 'Y',
          '浴': 'Y', '预': 'Y', '域': 'Y', '欲': 'Y', '喻': 'Y', '寓': 'Y', '御': 'Y', '裕': 'Y', '遇': 'Y', '愈': 'Y',
          '誉': 'Y', '豫': 'Y', '冤': 'Y', '元': 'Y', '园': 'Y', '员': 'Y', '原': 'Y', '圆': 'Y', '袁': 'Y', '援': 'Y',
          '缘': 'Y', '源': 'Y', '猿': 'Y', '远': 'Y', '怨': 'Y', '院': 'Y', '愿': 'Y', '曰': 'Y', '约': 'Y', '月': 'Y',
          '岳': 'Y', '悦': 'Y', '阅': 'Y', '跃': 'Y', '越': 'Y', '云': 'Y', '匀': 'Y', '允': 'Y', '孕': 'Y', '运': 'Y',
          '酝': 'Y', '晕': 'Y', '韵': 'Y', '蕴': 'Y',
          // Z
          '杂': 'Z', '砸': 'Z', '灾': 'Z', '栽': 'Z', '宰': 'Z', '载': 'Z', '再': 'Z', '在': 'Z', '咱': 'Z', '攒': 'Z',
          '暂': 'Z', '赞': 'Z', '赃': 'Z', '脏': 'Z', '葬': 'Z', '遭': 'Z', '糟': 'Z', '凿': 'Z', '早': 'Z', '枣': 'Z',
          '蚤': 'Z', '澡': 'Z', '藻': 'Z', '灶': 'Z', '皂': 'Z', '造': 'Z', '噪': 'Z', '燥': 'Z', '躁': 'Z', '则': 'Z',
          '责': 'Z', '贼': 'Z', '怎': 'Z', '增': 'Z', '憎': 'Z', '赠': 'Z', '扎': 'Z', '渣': 'Z', '札': 'Z', '轧': 'Z',
          '闸': 'Z', '炸': 'Z', '诈': 'Z', '榨': 'Z', '摘': 'Z', '宅': 'Z', '窄': 'Z', '债': 'Z', '寨': 'Z', '沾': 'Z',
          '展': 'Z', '斩': 'Z', '盏': 'Z', '崭': 'Z', '占': 'Z', '战': 'Z', '站': 'Z', '绽': 'Z', '章': 'Z', '张': 'Z',
          '彰': 'Z', '樟': 'Z', '涨': 'Z', '掌': 'Z', '丈': 'Z', '仗': 'Z', '帐': 'Z', '账': 'Z', '胀': 'Z', '障': 'Z',
          '招': 'Z', '找': 'Z', '召': 'Z', '兆': 'Z', '照': 'Z', '罩': 'Z', '遮': 'Z', '折': 'Z', '哲': 'Z', '者': 'Z',
          '这': 'Z', '浙': 'Z', '针': 'Z', '侦': 'Z', '珍': 'Z', '真': 'Z', '诊': 'Z', '枕': 'Z', '阵': 'Z', '振': 'Z',
          '镇': 'Z', '震': 'Z', '争': 'Z', '征': 'Z', '睁': 'Z', '筝': 'Z', '蒸': 'Z', '整': 'Z', '正': 'Z', '证': 'Z',
          '郑': 'Z', '政': 'Z', '症': 'Z', '之': 'Z', '支': 'Z', '只': 'Z', '芝': 'Z', '枝': 'Z', '知': 'Z', '织': 'Z',
          '肢': 'Z', '脂': 'Z', '蜘': 'Z', '执': 'Z', '直': 'Z', '值': 'Z', '职': 'Z', '植': 'Z', '殖': 'Z', '止': 'Z',
          '旨': 'Z', '址': 'Z', '纸': 'Z', '指': 'Z', '至': 'Z', '志': 'Z', '制': 'Z', '帜': 'Z', '治': 'Z', '质': 'Z',
          '致': 'Z', '秩': 'Z', '智': 'Z', '置': 'Z', '稚': 'Z', '中': 'Z', '忠': 'Z', '终': 'Z', '钟': 'Z', '肿': 'Z',
          '种': 'Z', '仲': 'Z', '众': 'Z', '重': 'Z', '州': 'Z', '舟': 'Z', '周': 'Z', '洲': 'Z', '粥': 'Z', '宙': 'Z',
          '昼': 'Z', '皱': 'Z', '骤': 'Z', '朱': 'Z', '株': 'Z', '珠': 'Z', '诸': 'Z', '猪': 'Z', '竹': 'Z', '烛': 'Z',
          '逐': 'Z', '主': 'Z', '煮': 'Z', '嘱': 'Z', '住': 'Z', '助': 'Z', '注': 'Z', '驻': 'Z', '柱': 'Z', '祝': 'Z',
          '著': 'Z', '筑': 'Z', '铸': 'Z', '抓': 'Z', '爪': 'Z', '专': 'Z', '砖': 'Z', '转': 'Z', '赚': 'Z', '庄': 'Z',
          '桩': 'Z', '装': 'Z', '壮': 'Z', '状': 'Z', '撞': 'Z', '追': 'Z', '准': 'Z', '捉': 'Z', '桌': 'Z', '卓': 'Z',
          '啄': 'Z', '浊': 'Z', '资': 'Z', '姿': 'Z', '滋': 'Z', '紫': 'Z', '仔': 'Z', '子': 'Z', '姊': 'Z', '籽': 'Z',
          '字': 'Z', '自': 'Z', '宗': 'Z', '棕': 'Z', '踪': 'Z', '总': 'Z', '纵': 'Z', '走': 'Z', '奏': 'Z', '租': 'Z',
          '足': 'Z', '卒': 'Z', '族': 'Z', '阻': 'Z', '组': 'Z', '祖': 'Z', '钻': 'Z', '嘴': 'Z', '最': 'Z', '罪': 'Z',
          '醉': 'Z', '遵': 'Z', '昨': 'Z', '左': 'Z', '佐': 'Z', '作': 'Z', '坐': 'Z', '座': 'Z', '做': 'Z'
        };
...
router.post('/residents', async (req, res) => {
  ...
  try {
    ...
    // 支持与户主关系字段（驼峰和下划线）
    const relationship_to_head = req.body.relationshipToHead || req.body.relationship_to_head || '其他';
    ...
    const registered_date = req.body.registeredDate || req.body.registered_date || new Date().toISOString().split('T')[0];
    ...
    console.log('解析后的数据:', { household_id, name, idCard, gender, dateOfBirth, relationship_to_head, occupation, health_status });
